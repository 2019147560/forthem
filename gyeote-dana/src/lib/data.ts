import { Program, Review, Support } from '@/types';
...
export const PROGRAMS: Program[] = [
  {
    ...
    bullets: [
      '주 1회, 회당 90분 이내 — 부담 없는 호흡',
      '동행 매니저가 지하철·약속 장소까지 함께',
      '결석에 대한 페널티 없음, 언제든 쉬어갈 수 있어요',
    ],
  },
  {
    id: 'p02',
...
export const REVIEWS: Review[] = [
  {
    id: 'r1',
    handle: '익명 청년 · 26',
    program: '천천히, 다시 만나는 일상',
    body: '처음엔 약속 장소에 가는 것조차 무서웠는데, 매니저님이 지하철역에서 같이 기다려주신다는 게 큰 안심이었어요. 8주 차에는 혼자서도 갈 수 있게 됐어요.',
    weeks: '8주 참여',
    color: 'sage',
  },
  {
    id: 'r2',
    handle: '익명 청년 · 24',
    program: '방 안에서 세상으로, 온라인 살롱',
    body: '카메라를 안 켜도 된다는 게 진짜 좋았어요. 텍스트로만 한 달 동안 참여했는데, 마지막 주에 처음으로 목소리를 냈어요. 누구도 다그치지 않았어요.',
    weeks: '4주 참여',
    color: 'terracotta',
  },
  {
    ...
    handle: '익명 청년 · 29',
    program: '식물 돌봄, 나도 돌봄',
    body: '말을 안 해도 같이 있는 시간이 어색하지 않다는 걸 처음 느꼈어요. 화분에 물 주는 일이 그렇게 큰 일이 될 줄 몰랐어요.',
    weeks: '6주 참여',
    color: 'cream',
  },
  {
    id: 'r4',
    handle: '익명 청년 · 27',
    program: '취업 전, 나를 알아가는 워크숍',
    body: '바로 취업하라는 압박이 없어서 좋았어요. 8주 동안 제가 뭘 견딜 수 있고 뭘 못하는지를 알아가는 시간이었어요.',
    weeks: '8주 수료',
    color: 'sage',
  },
  {
    id: 'r5',
    handle: '익명 청년 · 25',
    program: '늦은 밤 라디오, 청년 사연함',
    body: '잠 못 드는 밤에 켜놓을 수 있는 게 생겼다는 것만으로도 의미가 컸어요. 사연을 한 번도 못 보냈는데, 그래도 괜찮았어요.',
    weeks: '4주 참여',
    color: 'terracotta',
  },
];
...
export const SUPPORTS: Support[] = [
  { id: 's1', cat: '경제', title: '청년 자립지원금', org: '보건복지부', amount: '월 50만원 · 최대 6개월', body: '만 19~34세 은둔·고립 청년 대상 자립 준비 지원금. 주거 이전, 학습, 의료비 등 지정 항목에 사용 가능.' },
...
export const FILTER_DEFS = [
  { key: 'region', label: '지역', options: ['전체', '서울', '경기', '인천', '강원', '충청', '경상', '전라', '광주', '대구', '대전', '부산', '울산', '제주'] },
  { key: 'motive', label: '참여 동기', options: ['전체', '일상 회복', '사회 복귀', '관계 형성'] },
  { key: 'mode', label: '진행 형태', options: ['전체', '온라인', '오프라인', '온·오프라인'] },
  { key: 'period', label: '참여 기간', options: ['전체', '1회(원데이)', '2회·5회', '5회 이상'] },
  { key: 'support', label: '제공 지원', options: ['전체', '1:1 상담', '교통비', '재료비', '여행 경비'] },
  { key: 'status', label: '모집 여부', options: ['전체', '현재 신청 가능', '모집 예정', '마감'] },
] as const;

const POSTER_COLORS = ['poster-yellow', 'poster-pink', 'poster-mint', 'poster-orange', 'poster-lilac', 'poster-cream'];
export const posterColor = (id: string): string =>
  POSTER_COLORS[(id.charCodeAt(1) + parseInt(id.slice(1), 10)) % POSTER_COLORS.length];
